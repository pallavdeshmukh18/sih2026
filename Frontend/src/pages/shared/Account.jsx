    ...
    return (
        <div className="workspacePage" style={{ paddingBottom: "24px" }}>
            ...
            >
                ...
                <div className="workspaceGrid" style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: '24px' }}>
                    {/* Sidebar / Quick Profile */}
                    <div className="workspaceCard" style={{ background: "white", padding: "24px", borderRadius: "16px", border: "1px solid var(--color-border)", display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', height: 'fit-content' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        <div className="workspaceCard" style={{ background: "white", padding: "24px", borderRadius: "16px", border: "1px solid var(--color-border)" }}>
                            ...
                            <div className="workspaceGrid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
