...
const appointmentsData = [
    { id: 'APT-4829', doctor: 'Dr. Sarah Jenkins', dept: 'Cardiology', date: 'Oct 15, 2026', time: '10:00 AM', status: 'Upcoming', type: 'In-person' },
    { id: 'APT-4830', doctor: 'Dr. Robert Miles', dept: 'Dentistry', date: 'Oct 22, 2026', time: '02:30 PM', status: 'Upcoming', type: 'Virtual' },
    { id: 'APT-4710', doctor: 'Dr. Emily Chen', dept: 'General Practice', date: 'Sep 05, 2026', time: '11:15 AM', status: 'Completed', type: 'In-person' },
    { id: 'APT-4622', doctor: 'Dr. Sarah Jenkins', dept: 'Cardiology', date: 'Aug 12, 2026', time: '09:00 AM', status: 'Completed', type: 'In-person' },
];
        ...
        <div style={{ paddingBottom: "24px" }}>
            ...
            >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                        <h1 style={{ fontSize: "28px", fontFamily: "var(--font-sans)", fontWeight: "700", color: "var(--color-dark)" }}>Appointments</h1>
                        <p style={{ color: "var(--color-text-muted)", marginTop: "8px" }}>View upcoming schedules and past consultations.</p>
                    </div>
                ...
                <div style={{ background: "white", borderRadius: "16px", border: "1px solid var(--color-border)", overflow: "hidden" }}>
                    <div style={{ padding: "24px", borderBottom: "1px solid var(--color-border)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <h3 style={{ fontSize: "18px", fontWeight: "600", color: "var(--color-dark)" }}>My Schedule</h3>
                                        ...
                                        <td style={{ padding: "16px 24px" }}>
                                            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                                                <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: "var(--color-light-grey)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "600", color: "var(--color-teal)" }}>
                                                    {apt.doctor.split(' ')[1].charAt(0)}{apt.doctor.split(' ')[2]?.charAt(0)}
                                                </div>
                                                <div>
                                                    <div style={{ fontWeight: "600", fontSize: "14px", color: "var(--color-dark)" }}>{apt.doctor}</div>
                                                    <div style={{ fontSize: "12px", color: "var(--color-text-muted)" }}>{apt.id}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td style={{ padding: "16px 24px", fontSize: "14px", color: "var(--color-dark)" }}>{apt.dept}</td>
                                        <td style={{ padding: "16px 24px" }}>
                                            <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "14px", color: "var(--color-dark)", marginBottom: "4px" }}>
                                                <Calendar size={14} color="var(--color-text-muted)" /> {apt.date}
                                            </div>
