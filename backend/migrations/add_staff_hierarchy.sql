...
ALTER TABLE users
ADD COLUMN IF NOT EXISTS created_by_doctor_id INTEGER REFERENCES users(id) ON DELETE SET NULL;
...
-- 4. Verify the column was added (optional check)
-- SELECT column_name, data_type FROM information_schema.columns 
-- WHERE table_name = 'users' AND column_name = 'created_by_doctor_id';
