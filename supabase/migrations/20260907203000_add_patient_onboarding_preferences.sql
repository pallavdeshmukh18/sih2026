...
-- 1. Add state, preferred_language, interaction_mode, and accessibility_preference
--    columns to patient_profiles table.
...
-- 2. Add CHECK constraints for valid enum values (allowing NULL for existing unonboarded patients)
DO $$
BEGIN
    IF NOT EXISTS (
...
-- 3. Add performance index on preferred_language for regional query filtering
